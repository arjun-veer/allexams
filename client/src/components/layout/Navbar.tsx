...
import { Menu, X, ChevronDown, User, LogOut, Bell, Settings, Shield } from 'lucide-react';
        ...
        <nav className="flex items-center justify-between">
          ...
          >
            <div className="rounded-md bg-primary p-1 text-primary-foreground">
              <span className="sr-only">All Exams</span>
              <svg 
            ...
            <span className="hidden sm:inline">AllExams</span>
          </Link>
