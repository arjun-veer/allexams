...
const Index = () => {
  ...
  // derive upcoming from live exams
  const upcomingExams = exams
    .filter((e) => e.examDate && new Date(e.examDate) > new Date())
    .sort((a, b) => (a.examDate && b.examDate ? new Date(a.examDate).getTime() - new Date(b.examDate).getTime() : 0))
    .slice(0, 3);

  console.log('Index page - total exams:', exams.length, 'upcoming:', upcomingExams.length);
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {upcomingExams.length ? (
              ...
              <div className="col-span-full text-muted-foreground">No upcoming exams found.</div>
            )}
          </div>
        </div>
      </section>
