        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <div>
              ...
              <div className="mt-1">
                {formatDateFromDb(exam.registration_start_date)} - {formatDateFromDb(exam.registration_end_date)}
              </div>
            </div>
            
            <div>
              <span className="text-sm font-medium text-muted-foreground">Exam Date:</span>
              <div className="mt-1">{formatDateFromDb(exam.exam_date)}</div>
            </div>
            
            <div>
              <span className="text-sm font-medium text-muted-foreground">Result Date:</span>
              <div className="mt-1">{formatDateFromDb(exam.result_date)}</div>
            </div>
            
            {exam.answer_key_date && (
              <div>
                <span className="text-sm font-medium text-muted-foreground">Answer Key Date:</span>
                <div className="mt-1">{formatDateFromDb(exam.answer_key_date)}</div>
              </div>
            )}
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <div className="mt-1">{formatDateFromDb(exam.created_at)}</div>
            </div>
          </div>
        </div>
      </CardContent>
